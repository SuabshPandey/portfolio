          ...
          <div className={`${styles.about_right_div} col-lg-7 col-md-6`}>
            <div className={styles.about_content_div}>
              <p className={styles.sub_content}>
                I am an IT engineer and web developer, with a bachelor's degree
                in Information Technology from Pokhara University. I always put
                in my best effort and try to stay humble. <br /> <br />I have
                been creating websites for the past two years. I have worked on
                many projects and have gained a lot of experience. I am always
                looking for new opportunities to learn and grow. I am a
